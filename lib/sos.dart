...
class _sosState extends State<sos> {
  ...
  Widget build(BuildContext context) {
    deleteitem(String placename1) async {
      ...
      FirebaseFirestore.instance.collection('users').doc(user.uid).collection("sos").doc(placename1).delete();
    }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          StreamBuilder(
              stream:FirebaseFirestore.instance.collection("users").doc(FirebaseAuth.instance.currentUser!.uid).collection("sos").snapshots(),
